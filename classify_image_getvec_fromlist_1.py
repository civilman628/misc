...
def run_inference_on_image():
  ...
  #filelist=open('/home/scopeserver/RaidDisk/DeepLearning/mwang/tensorflow/tensorflow/models/image/imagenet/list.txt','r')
  with open('/home/scopeserver/RaidDisk/DeepLearning/mwang/tensorflow/tensorflow/models/image/imagenet/testv2.txt','r') as reader:
    filelist = [line.rstrip() for line in reader]

  #for i in range(1,346521):
  for image in filelist:
  #for image in sorted(os.listdir("/home/scopeserver/RaidDisk/DeepLearning/mwang/data/google_lace/")):
    #image=image.replace("\n","")
    #print (image)

    #image=filelist[i]
    if image.lower().endswith("jpg"):
      #image=os.path.join("/home/scopeserver/RaidDisk/DeepLearning/mwang/data/google_lace/",image)
      ...
      try:
        with tf.Session() as sess:
          with tf.device("/gpu:0"):
            ...
            #os.remove()
            with open("fashion_lists_1024.txt", 'a') as f:
              #for s in image:
              f.write(image +'\n')
            with open("fashion_feature_1024.txt", 'a') as q:
        ...
        #os.remove(image)
        with open("fashion_error_1024.txt", 'a') as t:
           t.write(image +'\n')
