...
def run_inference_on_image():
  ...
  for image in sorted(os.listdir("/home/scopeserver/RaidDisk/DeepLearning/mwang/BEGAN-tensorflow/data/dresses/splits/train_source/")):
    if image.endswith(".jpg"):
      image=os.path.join("/home/scopeserver/RaidDisk/DeepLearning/mwang/BEGAN-tensorflow/data/dresses/splits/train_source/",image)
      ...
      resize_image=tf.image.resize_images(image_buffer,[299,299])
      ...
      try:
        with tf.Session() as sess:
          with tf.device("/gpu:0"):
            ...
            #os.remove()
            with open("filelist_dress.txt", 'a') as f:
              #for s in image:
              f.write(image +'\n')
            with open("features_dress.txt", 'a') as q:
        ...
        #os.remove(image)
        #with open("errorfilelist.txt", 'a') as f:
         #  f.write(image +'\n')
