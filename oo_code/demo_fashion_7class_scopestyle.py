...
PATH_TO_CKPT='/home/scopeserver/RaidDisk/DeepLearning/mwang/models/object_detection/fashion_7classes.pb'
PATH_TO_LABELS='/home/scopeserver/RaidDisk/DeepLearning/mwang/models/object_detection/data/where2buy_label_map.pbtxt'
NUM_CLASSES = 7
...
class fashiondetection(object):
    ...
    def demo(self, url):
        ...
        if im_height < 300 or im_height < 300:
            return result
        ...
        for i in range(boxes.shape[0]):
            if scores is None or scores[i] > min_score_thresh:
                ...
                (left, right, top, bottom) = (xmin * im_width, xmax * im_width,
                 ...
                 #   continue
                #else:
                result_dir['name'] = str(self.category_index[classes[i]]['name'])
