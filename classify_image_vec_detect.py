...
def run_inference_on_image():
    ...
    # filelist=open('/home/scopeserver/RaidDisk/DeepLearning/mwang/tensorflow/tensorflow/models/image/imagenet/f.txt','r')
    with open('/home/scopeserver/RaidDisk/DeepLearning/mwang/tensorflow/tensorflow/models/image/imagenet/scope_1.txt', 'r') as reader:
    ...
    for image in box:
        ...
        filename='/home/scopeserver/RaidDisk/DeepLearning/mwang/data/scopestyle_all/'+fileid+'.jpg'
        #image = filelist[i]
        if filename.lower().endswith("jpg"):
            ...
            try:
                ...
                cropped_image_filename='/home/scopeserver/RaidDisk/DeepLearning/mwang/data/fashion_1m_detect_2objects/'+classname+'/'+str(fileid)+'.jpg'

                if os.path.isfile(cropped_image_filename):
                    cropped_image_filename='/home/scopeserver/RaidDisk/DeepLearning/mwang/data/fashion_1m_detect_2objects/'+classname+'/'+str(fileid)+'_'+str(random.randint(0,100))+'.jpg'
                ...
                # os.remove()
                with open("detect_file_1.txt", 'a') as f:
                    # for s in image:
                 	f.write(cropped_image_filename + '\n')
                with open("detect_feature_1.txt", 'a') as q:
                ...
                # os.remove(image)
                with open("scope_match_error.txt", 'a') as t:
                    t.write(image + '\n')
