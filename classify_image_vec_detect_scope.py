...
def run_inference_on_image():
    ...
    with open('/home/scopeserver/RaidDisk/DeepLearning/mwang/tensorflow/tensorflow/models/image/imagenet/scope_all_elements.txt', 'r') as reader:
    ...
    for image in box:
        ...
        if filename.lower().endswith("jpg"):
            ...
            try:
                ...
                cropped_image_filename='/home/scopeserver/RaidDisk/DeepLearning/mwang/data/scope_parts/'+classname+'/'+str(fileid)+'.jpg'

                if os.path.isfile(cropped_image_filename):
                    cropped_image_filename='/home/scopeserver/RaidDisk/DeepLearning/mwang/data/scope_parts/'+classname+'/'+str(fileid)+'_'+str(random.randint(0,100))+'.jpg'
                ...
                # os.remove()
                with open("scope_all_parts.txt", 'a') as f:
                    # for s in image:
                 	f.write(cropped_image_filename + '\n')
                with open("scope_parts_feature.txt", 'a') as q:
