...
def run_inference_on_image():
    ...
    with open('/home/scopeserver/RaidDisk/DeepLearning/mwang/tensorflow/tensorflow/models/image/imagenet/wholeperson_filelsit.txt', 'r') as reader:
    ...
    #for i in range(0, 86495):
        ...
        if image.lower().endswith("jpg"):
            ...
            try:
                ...
                #dims = image_decoded.get_shape().as_list()
                ...
                # os.remove()
                with open("wholeperson_list.txt", 'a') as f:
                    # for s in image:
                    f.write(image + '\n')
                with open("wholeperson_feature.txt", 'a') as q:
                ...
                # os.remove(image)
                with open("wholeperson_error.txt", 'a') as t:
                    t.write(image + '\n')
